...
import thumbnailHelperNumbered from '@assets/thumbnail_helper_numbered.png';
import thumbnailHelperNormal from '@assets/thumbnail_helper_normal.png';
import thumbnailHelperHighlighted from '@assets/thumbnail_helper_highlighted.png';
...
<div align="center">
  <img src={thumbnailHelperNumbered.src} alt="alt"/>
  <br/>
...
| <img src={thumbnailHelperNormal.src} alt="alt-1"/>      | <img src={thumbnailHelperHighlighted.src} alt="alt-2"/> |
| ----------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| Normal view                                                             |                                                                         |
